...
class MainDataEntry(BaseDataEntry):
  ...
  population_gender = models.CharField("gender", max_length = 1, choices = BaseDataEntry.GENDER_CHOICES, default = 'U', null = True)
  population_value = models.DecimalField("value", max_digits = 17, decimal_places = 3) #, null = True, blank = True)
